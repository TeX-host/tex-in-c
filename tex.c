...
Static void initprim(void)
{
 /*226:*/
  ...
  primitive(S(346), assignglue,
	    gluebase + abovedisplayshortskipcode);
  primitive(S(347), assignglue,
  ...
  primitive(S(1099), assigndimen,
	    dimenbase + delimitershortfallcode);
  primitive(S(1100), assigndimen,
