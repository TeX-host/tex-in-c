...
void print_meaning(int cur_chr, int cur_cmd) {
    ...
    _getnext_LN__reswitch:
        ...
        switch (STATE + _cur_cmd) {
            ...
            case NEW_LINE + ESCAPE:
                ...
                if (LOC > LIMIT) {
                    _cur_cs = NULL_CS; // state is irrelevant in this case
                } else {             // LOC <= LIMIT
                ...
                _getnext_LN__startcs_:
                    ...
                    if (cat == LETTER && k <= LIMIT) {
                        ...
                        if (k > LOC + 1) {
                            ...
                            _cur_cs = idlookup_p(buffer + LOC, k - LOC,
                    ...
                    _cur_cs = ACTIVE_BASE + buffer[LOC];
                    LOC++;
                } // if (LOC <> LIMIT)
